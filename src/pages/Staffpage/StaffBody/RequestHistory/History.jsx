...
const History = ({reqHistory}) => {
    ...
    const handleClaim = () => {
        ...
        const requestOptions = {
            ...
            fetch("https://imprsonlineback-production.up.railway.app/records/claimedStatus?requestID=" + requestID + "&role=" + role + "&status=Claimed&email=" + email  + "&userID=" + userID + "&date=" + currentDate, requestOptions).then((response)=> response.json()
            ).then((data) => {
