...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://imprsonlineback-production.up.railway.app/notifications/id?id=" + localStorage.getItem("userID"), requestOptions)
    ...
    if (localStorage.getItem("isLoggedIn") === "true") {
      fetch("https://imprsonlineback-production.up.railway.app/services/checkAdmin?email=" + localStorage.getItem("email"), requestOptions)
        .then((response) => response.json())
        .then((data) => {
          if (data !== true) {
            setNotifShow('show');
  ...
  const handleContentClick = (requestID) => {
    fetch(`https://imprsonlineback-production.up.railway.app/comments/id?id=${requestID}`)
      .then((response) => response.json())
      .then((data) => {
