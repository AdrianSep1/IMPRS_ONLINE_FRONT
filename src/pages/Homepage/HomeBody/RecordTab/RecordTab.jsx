        ...
        fetch("http://localhost:8080/requests/all", requestOptions)
            ...
            .then((data) => {
                ...
                const filteredData = updatedData.filter(item => {
                    console.log(`Comparing userID: ${item.schoolId} with schoolId: ${schoolId}`);
                    const isMatch = item.schoolId === schoolId;
                    if (isMatch) {
                        console.log(`Match found: userID ${item.schoolId} is equal to schoolId ${schoolId}`);
                    }
                    return isMatch;
                });
